    ...
    for (const name in this.tile.layers) {
      ...
      for (let i = 0; i < layer.length; i++) {
        ...
        const sort = feature.properties.localrank || feature.properties.scalerank;
          const label = style.type === 'symbol' ? feature.properties['name_' + config.language] || feature.properties['name_' + config.languageBackup] || feature.properties.name || feature.properties.house_num : void 0;
        if (style.type === 'fill') {
