    ...
    for (const name in this.tile.layers) {
      ...
      for (let i = 0; i < layer.length; i++) {
        ...
        const sort = feature.properties.localrank || feature.properties.scalerank;
          const label = style.type === 'symbol' ? feature.properties['name:ga'] || feature.properties['name_ga'] || feature.properties['namega']: void 0;// + config.language] || feature.properties['name:' + config.languageBackup] || feature.properties.name || feature.properties.house_num : void 0;
        if (style.type === 'fill') {
